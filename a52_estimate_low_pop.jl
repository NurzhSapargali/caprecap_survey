...
OUTPUT_FOLDER::String = "./_900_output/data/appendix/low_pop/" # Folder to save estimation results
...
for alpha in ALPHAS
    ...
    output_file = OUTPUT_FOLDER * "estimates_$(alpha)_low_pop_mplenb.csv"
    ...
    data_folder = DATA_FOLDER * "alpha_$(alpha)_low_pop/"
    for N in pops
