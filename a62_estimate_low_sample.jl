"""
Run estimation methods on simulated low sample data and save results to CSV files.
"""
...
for alpha in ALPHAS
    ...
    output_file = OUTPUT_FOLDER * "estimates_$(alpha)_low_sample_mplenb.csv"
    ...
    data_folder = DATA_FOLDER * "alpha_$(alpha)_low_sample/"
    for N in pops
