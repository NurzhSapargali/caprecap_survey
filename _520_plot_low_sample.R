...
plot_everything(
  ...
  ylim_bias = c(NA, 10),
  ylim_rmse = c(NA, 4.0),
  #filename_suffix = "_low_sample_intermediate", # Consider only intermediate results, all output files will have this suffix, e.g., estimates_box_2.0_low_sample_intermediate.pdf
)