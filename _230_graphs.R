...
SBM_BLOCK_SIZES <- c(500, 500)
SBM_BLOCK_EDGE_PROPS <- list(
  assortative = c(9 / 20, 7 / 20, 4 / 20), # Assortative
  disassortative = c(7 / 20, 4 / 20, 9 / 20), # Disassortative
  core_periphery = c(9 / 20, 4 / 20, 7 / 20) # Core-periphery
)
DRAWS <- 20
TRIALS <- 100
BA_FOLDER <- "./_200_input/graphs/ba_%s/"
ER_FOLDER <- "./_200_input/graphs/er_%s/"
SBM_FOLDER <- "./_200_input/graphs/sbm_%s/%s/"
